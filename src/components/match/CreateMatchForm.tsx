...
interface CreateMatchFormProps {
  onMatchCreated?: (data: {id: number; name: string}) => void;
}

const CreateMatchForm = ({ onMatchCreated }: CreateMatchFormProps) => {
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="pt-4 flex justify-end">
            <Button type="submit" className="rounded-full" onClick={handleSubmit}>
